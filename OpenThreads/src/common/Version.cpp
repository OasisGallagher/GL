...
const char* OpenThreadsGetVersion()
{
    ...
    {
        snprintf(OpenThreads_version, sizeof(OpenThreads_version), "%d.%d.%d",OPENTHREADS_MAJOR_VERSION,OPENTHREADS_MINOR_VERSION,OPENTHREADS_PATCH_VERSION);
...
const char* OpenThreadsGetSOVersion()
{
    ...
    {
        snprintf(OpenThreads_soversion, sizeof(OpenThreads_soversion), "%d",OPENTHREADS_SOVERSION);
