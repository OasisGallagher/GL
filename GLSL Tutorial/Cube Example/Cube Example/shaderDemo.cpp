...
GLuint setupShaders() {
	...
	glBindFragDataLocation(shader.getProgramIndex(), 0, "outputF"); //shader.setProgramOutput(0, "outputF");
	glBindAttribLocation(shader.getProgramIndex(), VSShaderLib::VERTEX_COORD_ATTRIB, "position"); //shader.setVertexAttribName(VSShaderLib::VERTEX_COORD_ATTRIB, "position");
